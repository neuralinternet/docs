...
BASE_DEEPWIKI_URL = "https://deepwiki.com/neuralinternet/ni-compute" # Confirmed from brief (ensure this is the correct one you want to use)
...
ROOT_DEEPWIKI_PAGE_HREF = "/neuralinternet/ni-compute/1-overview" 

# --- GitHub Repository Details (for resolving source links) ---
GITHUB_REPO_URL = "https://github.com/neuralinternet/SN27" # e.g., "https://github.com/your-org/your-repo"
GITHUB_REF = "6261c454"  # Branch name, commit hash, or tag (e.g., "main", "develop", "v1.0.0", or a specific commit SHA like 'bb2fc2a9')
...
TARGET_DOCS_DIR = "/Users/monkey/ni-docs/src/content/docs" 
...
CHROMEDRIVER_EXECUTABLE_PATH = "/Users/monkey/chromedriver-mac-arm64/chromedriver" # Please update this to your actual path
...
BRAVE_EXECUTABLE_PATH = "/Applications/Brave Browser.app/Contents/MacOS/Brave Browser" # Please update or set to None
